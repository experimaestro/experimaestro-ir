...
@argument("storeContents", default=False, help="Store processed documents (e.g. with HTML tags)")
@argument("stemmer", default="porter", checker=Choices(["porter", "krovetz", "none"]), help="The stemmer to use")
@data()
class Index(Base): 
    pass