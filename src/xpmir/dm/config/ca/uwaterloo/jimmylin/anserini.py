...
@tardownloader(
    "index",
    url="https://git.uwaterloo.ca/jimmylin/anserini-indexes"
    "/raw/master/index-robust04-20191213.tar.gz",
...
def robust04(index):
    ...
    Pre-computed Anserini index of the Robust 2014 collection; used parameters
    can be found at https://git.uwaterloo.ca/jimmylin/anserini-indexes"
    "/-/blob/master/index-robust04-20191213-readme.txt
    """
    return {
        "path": index,
        "storePositions": True,
