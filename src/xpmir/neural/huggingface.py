    ...
    def forward(
        ...
        with torch.set_grad_enabled(torch.is_grad_enabled()):
            ...
            result = self.encoder.model(
                ...
                # Not all HF models use token_type_ids, so we check if they are present before passing to the model
                token_type_ids=to_device(tokenized.token_type_ids, self.device) if tokenized.token_type_ids is not None else None,
