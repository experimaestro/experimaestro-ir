...
def compute_metrics(
    qids_to_relevant_passageids, qids_to_ranked_candidate_passages, max_rank=MaxMRRRank
):
    """Compute MRR metric
    Args:
    p_qids_to_relevant_passageids (dict): dictionary of query-passage mapping
...
def compute_metrics_from_files(
    path_to_reference, path_to_candidate, perform_checks=True, max_rank=MaxMRRRank
):
    """Compute MRR metric
    Args:
    ...
    return compute_metrics(
        qids_to_relevant_passageids, qids_to_ranked_candidate_passages, max_rank
    )
