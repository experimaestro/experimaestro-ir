...
from xpmir.metrics import BaseMetrics, Metric
...
class FallbackMetrics(BaseMetrics):
    def __init__(self, metrics_priority_list: List[BaseMetrics]):
        self.metrics_priority_list = metrics_priority_list

    def supports(self, metric: Union[str, Metric]) -> bool:
    ...
    def calc_metrics(
        ...
        metrics = set(map(Metric.parse, metrics))
        result = {}
